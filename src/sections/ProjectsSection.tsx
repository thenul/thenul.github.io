          ...
          {projects.map((project, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative flex flex-col rounded-xl overflow-hidden border border-slate-800 bg-[#161B26] hover:border-slate-700 transition-all duration-300"
              ...
              >
                <div className="p-6 lg:p-8 flex flex-col lg:flex-row gap-8">
                  ...
                  <div className="w-full lg:w-1/2 flex flex-col gap-6">
                    ...
                    {project.image ? (
                      <div className="relative aspect-video w-full rounded-lg overflow-hidden border border-slate-800 bg-slate-950 flex items-center justify-center">
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#0b0f17]/95 to-transparent flex items-end p-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-slate-100 group-hover:text-cyan-300 transition-colors flex items-center gap-2 mb-1">
                      ...
                      {/* Description */}
                      <div className="text-slate-400 leading-relaxed text-sm space-y-4 font-light whitespace-pre-line px-6">
                        {project.description}
                      </div>
                        ...
                        <div className="flex flex-wrap gap-3 mt-5 px-6">
                          {project.links.map(link => (
                            <a
                              ...
                              className="px-3.5 py-1.5 rounded bg-[#1a1d26] border border-slate-800 hover:border-cyan-500/25 text-slate-100 hover:text-cyan-300 font-mono text-[11px] font-medium tracking-wide transition-all flex items-center gap-1.5 cursor-pointer"
                            >
                        ...
                        <div className="mt-6 space-y-3 px-6">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            {project.tasks.map((task, idx) => (
                              <div key={idx} className="p-3.5 rounded-lg bg-[#0b0f17]/90 border border-slate-800 flex flex-col gap-1.5">
                  ...
                  <div className="w-full lg:w-1/2 flex flex-col">
                    <div className="rounded-lg border border-slate-800 bg-[#0b0f17] overflow-hidden flex-grow flex flex-col shadow-xl min-h-[350px]">
                      {/* Tab bar header */}
                      <div className="h-11 bg-[#161B26] border-b border-slate-800 flex items-center justify-between px-4">
                      ...
                      {/* Tab content panel */}
                      <div className="p-4 flex-grow bg-[#161B26]/10 flex flex-col justify-start">
                        {currentTab === 'code' ? (
